...
export const AVAILABLE_BIBLES: BibleDownloadInfo[] = [
  ...
  },
  {
    ...
    abbreviation: 'ASV',
    language: 'en',
    description: 'Public domain English translation (1901)',
    downloadUrl: 'https://api.getbible.net/v2/asv.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    ...
    abbreviation: 'BBE',
    language: 'en',
    description: 'Simple English translation (1965)',
    downloadUrl: 'https://api.getbible.net/v2/basicenglish.json',
    fileSize: '~4 MB',
    isPublicDomain: true,
  },
  {
  ...
  },
  {
    ...
    abbreviation: 'CUT',
    language: 'zh',
    description: '繁體中文 (1919)',
    downloadUrl: 'https://api.getbible.net/v2/cut.json',
    fileSize: '~4 MB',
    isPublicDomain: true,
  },
  {
    id: 'cus',
    name: '和合本 (Chinese Union Simplified)',
    abbreviation: 'CUS',
    language: 'zh',
    description: '简体中文 (1919)',
    downloadUrl: 'https://api.getbible.net/v2/cus.json',
    fileSize: '~4 MB',
    isPublicDomain: true,
  },
  {
    id: 'japkougo',
    name: '口語訳 (Japanese Kougo-yaku)',
    abbreviation: 'JKY',
    language: 'ja',
    description: '日本語口語訳聖書 (1955)',
    downloadUrl: 'https://api.getbible.net/v2/japkougo.json',
    fileSize: '~4 MB',
    isPublicDomain: true,
  },
  {
    ...
    abbreviation: 'LSG',
    language: 'fr',
    description: 'French translation (1910)',
    downloadUrl: 'https://api.getbible.net/v2/ls1910.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    ...
    abbreviation: 'LUT',
    language: 'de',
    description: 'German translation (1545)',
    downloadUrl: 'https://api.getbible.net/v2/luther1545.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    ...
    downloadUrl: 'https://api.getbible.net/v2/almeida.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    id: 'giovanni',
    name: 'Giovanni Diodati Bible',
    abbreviation: 'GDB',
    language: 'it',
    description: 'Italian translation (1649)',
    downloadUrl: 'https://api.getbible.net/v2/giovanni.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    ...
    abbreviation: 'CRN',
    language: 'ro',
    description: 'Romanian translation (1921)',
    downloadUrl: 'https://api.getbible.net/v2/cornilescu.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
  {
    ...
    abbreviation: 'SVD',
    language: 'ar',
    description: 'Arabic translation (1865)',
    downloadUrl: 'https://api.getbible.net/v2/arabicsv.json',
    fileSize: '~5 MB',
    isPublicDomain: true,
  },
];
...
export const versesToSlides = (
  ...
  if (displayMode === 'one-per-slide') {
    ...
    return verses.map((verse) => ({
      ...
      lineRoles: ['body', 'reference'] as ('body' | 'reference')[],
